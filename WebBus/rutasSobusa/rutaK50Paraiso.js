...
var rutaA1 = [
    ...
    [10.9850, -74.8150], // Carrera 3
    [10.9800, -74.8100], // Ciudad Salitre
    [10.9750, -74.8050], // Calle 68B
    [10.9700, -74.8000], // Los Nísperos
    ...
    [10.9755, -74.7900], // Carrera 53
    [10.9900, -74.7850], // Calle 70
    [10.9850, -74.7800], // Carrera 50
    [11.0000, -74.7750], // Calle 87
    [10.9950, -74.7800], // Carrera 53
    [11.0050, -74.7700], // Calle 90
    [11.0100, -74.7650], // Carrera 64
    [11.0150, -74.7600], // Calle 91
    [11.0180, -74.7550], // Carrera 64B
    [11.0120, -74.7500], // Calle 86
    [11.0200, -74.7450], // Carrera 71
    [11.0250, -74.7500], // Calle 85
    [11.0300, -74.7550], // Carrera 70
    [11.0250, -74.8050], // Paraíso
    [11.0200, -74.8100], // Carrera 68
    [11.0150, -74.8050], // Calle 79
    [11.0100, -74.8000], // Vía 40
    [11.0050, -74.7950], // Calle 76
    [11.0000, -74.7900], // Carrera 62
    [10.9950, -74.7850], // Calle 68
    [10.9900, -74.7800], // Parque Cisneros
    [10.9850, -74.7750], // Calle 66
    [10.9800, -74.7700], // Carrera 66
    [10.9755, -74.7900], // Calle 58
    [10.9755, -74.7900], // Carrera 54
    [10.9700, -74.7850], // Calle 54
    [10.9850, -74.7800], // Carrera 50
    [10.9650, -74.7750], // Calle 42
    [10.9850, -74.7800], // Carrera 44
    [10.9700, -74.7850], // Calle 37
    [10.9650, -74.7900], // Carrera 38
    [10.9600, -74.7800], // Calle 17
    [10.9650, -74.7700], // Simón Bolívar
    [10.9700, -74.7800], // Circunvalar
