...
var rutaA1 = [
    ...
    [10.9700, -74.7800], // Av Circunvalar
    [10.9750, -74.7750], // Calle 90B
    [10.9650, -74.7700], // Carrera 6Sur
    [10.9750, -74.7650], // Calle 92
    [10.9700, -74.7600], // Carrera 2
    [10.9600, -74.7550], // Diagonal 54C
    [10.9550, -74.7500], // Transversal 1D
    [10.9500, -74.7450], // Calle 55B
    [10.9550, -74.7400], // Carrera 1E
    [10.9500, -74.7350], // Calle 55C
    [10.9550, -74.7300], // Carrera 2A
    [10.9650, -74.7250], // Calle 73D
    [10.9700, -74.7300], // Carrera 3C
    [10.9600, -74.7350], // Calle 53
    [10.9650, -74.7400], // Carrera 4A
    [10.9550, -74.7450], // Calle 52C
    [10.9500, -74.7500], // Carrera 8
    [10.9450, -74.7550], // Calle 42B
    [10.9500, -74.7600], // Carrera 8G
    [10.9450, -74.7650], // Calle 40B
    [10.9600, -74.7900], // Carrera 14
    [10.9600, -74.7900], // Calle 30
    [10.9550, -74.7950], // Mercado
    [10.9600, -74.7900], // Calle 30
    [10.9600, -74.7800], // Carrera 14
    [10.9450, -74.7650], // Calle 40B
    [10.9500, -74.7500], // Carrera 8
    [10.9550, -74.7450], // Calle 52C
    [10.9650, -74.7400], // Carrera 4A
