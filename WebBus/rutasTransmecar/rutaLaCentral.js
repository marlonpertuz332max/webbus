...
// PUNTOS CLAVE
var rutaA1 = [
    [10.9900, -74.8200], // NEVADA NUEVA ESPERANZA
    [10.9850, -74.8150], // Diagonal 78
    [10.9800, -74.8100], // Carrera 2
    [10.9750, -74.8050], // Diagonal 71
    [10.9700, -74.8000], // Carrera 4
    [10.9680, -74.7950], // Calle 69
    [10.9650, -74.7900], // Carrera 5 (La Central)
    [10.9600, -74.7850],
    [10.9550, -74.7800], // Granabastos (retorno)
    [10.9600, -74.7850], // vuelve Murillo
    [10.9650, -74.7800], // Carrera 14
    [10.9700, -74.7750], // Terminal
    [10.9680, -74.7700], // Calle 54
    [10.9650, -74.7650], // Carrera 11
    [10.9600, -74.7600], // Calle 43
    [10.9620, -74.7700], // Carrera 14
    [10.9580, -74.7750], // Calle 41
    [10.9550, -74.7800], // Carrera 15B
    [10.9600, -74.7850], // Calle 48
    [10.9650, -74.7900], // Carrera 24
    [10.9700, -74.7850], // Avenida El Platanal
    [10.9600, -74.7700], // Calle 41
    [10.9550, -74.7600], // Carrera 17
    [10.9500, -74.7500], // Autopista aeropuerto
    [10.9650, -74.7800], // Carrera 19
    [10.9700, -74.7850], // Calle 21
    [10.9650, -74.7900], // Carrera 16
    [10.9600, -74.7700], // Calle 18
    [10.9600, -74.7800], // Calle 17
    [10.9650, -74.7850], // Carrera 26
    [10.9700, -74.7800], // Calle 21
    [10.9750, -74.7850], // Carrera 28
    [10.9800, -74.7900], // Calle 30
    [10.9750, -74.7950], // Carrera 39
    [10.9700, -74.7900], // Calle 33
    ...
    [10.9600, -74.7700], // Calle 18
    [10.9650, -74.7800], // Carrera 19
    [10.9500, -74.7500], // Autopista
    [10.9550, -74.7600], // Carrera 17
    [10.9700, -74.7850], // El Platanal
    [10.9650, -74.7900], // Carrera 24
    [10.9600, -74.7850], // Calle 48
    [10.9550, -74.7800], // Carrera 15B
    [10.9580, -74.7750], // Calle 41
    [10.9620, -74.7700], // Carrera 14
    [10.9680, -74.7700], // Calle 54
    [10.9650, -74.7900], // Carrera 15
    [10.9600, -74.7850], // Avenida Murillo
    [10.9650, -74.7900], // Carrera 5
    [10.9680, -74.7950], // Calle 69
    [10.9700, -74.8000], // Carrera 4
    [10.9750, -74.8050], // Diagonal 71
    [10.9800, -74.8100], // Carrera 2
