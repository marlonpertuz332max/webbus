...
// PUNTOS CLAVE
var rutaA1 = [
    [10.9345, -74.7745], // Nevada Sodis (Soledad)
    [10.9400, -74.7700], // Autopista al Aeropuerto
    [10.8896, -74.7808], // Aeropuerto Ernesto Cortissoz
    [10.9500, -74.7600], // Calle 30
    [10.9650, -74.8000], // Avenida Circunvalar
    [10.9755, -74.7900], // Carrera 53
    [10.9855, -74.7805], // Calle 98
    [10.9820, -74.7800], // Carrera 51B
    [10.9750, -74.7855], // Calle 84
    [10.9755, -74.7900], // Carrera 53 (punto clave)
    [10.9680, -74.7900], // Regreso Circunvalar
    [10.9705, -74.7480], // Calle 30
    [10.9400, -74.7700]  // Autopista (retorno)
];
