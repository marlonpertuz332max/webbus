...
var rutaA1 = [
    ...
    [10.9700, -74.7750], // El Manantial
    [10.9650, -74.7700], // Carrera 13
    [10.9750, -74.7700], // Calle 72
    [10.9700, -74.7680], // Carrera 12D
    [10.9800, -74.7650], // Calle 75
    [10.9700, -74.7700], // Carrera 12A
    [10.9600, -74.7750], // Calle 56
    [10.9550, -74.7800], // Carrera 9D
    [10.9500, -74.7850], // Calle 54
    [10.9450, -74.7900], // Carrera 8
    [10.9500, -74.7950], // Calle 52
    [10.9550, -74.7900], // Carrera 11
    [10.9600, -74.7850], // Calle 43
    [10.9650, -74.7800], // Carrera 14
    [10.9600, -74.7750], // Calle 41
    [10.9700, -74.7600], // Carrera 17
    [10.9800, -74.7500], // Autopista aeropuerto
    [10.9600, -74.7900], // Calle 30
    [10.9700, -74.8000], // Carrera 39
    [10.9750, -74.7950], // Calle 33
    [10.9650, -74.7900], // Carrera 38
    [10.9700, -74.7850], // Calle 38
    [10.9750, -74.7800], // Carrera 43
    [10.9850, -74.7950], // Calle 53
    [10.9755, -74.7900], // Carrera 54
    [10.9780, -74.7850], // Calle 58
    [11.0100, -74.8000], // Vía 40
    [11.0250, -74.8000], // Calle 85
    [11.0300, -74.8100], // Carrera 76
    [11.0200, -74.8050], // Calle 89
    [11.0150, -74.8100], // Carrera 75A
    [11.0100, -74.8050], // Calle 92
    [11.0050, -74.8000], // Carrera 73
    [11.0100, -74.7950], // Calle 93
    [11.0200, -74.7900], // Carrera 71
    [11.0300, -74.8050], // Calle 98
    ...
    [11.0200, -74.7480], // Carrera 41G
    [11.0250, -74.7420], // Calle 116
    [11.0250, -74.7450], // Calle 118
    [11.0100, -74.7600], // Circunvalar
    [11.0000, -74.7700], // Carrera 51B
    [11.0200, -74.8000], // Calle 86
    [11.0150, -74.7950], // Carrera 50
    [11.0200, -74.7900], // Calle 87
    [11.0000, -74.7700], // Carrera 53
    [11.0100, -74.8050], // Calle 94
    [11.0200, -74.7900], // Carrera 71
    [11.0250, -74.8000], // Calle 85
    [11.0150, -74.7900], // Carrera 65
    [11.0100, -74.7850], // Calle 81B
    [11.0050, -74.7800], // Carrera 64
    [11.0100, -74.7750], // Calle 82
    [11.0000, -74.7700], // Carrera 59B
    [11.0050, -74.7750], // Carrera 59
    [11.0050, -74.7950], // Calle 76
    [10.9755, -74.7900], // Carrera 54
    [11.0100, -74.8000], // Vía 40
    [10.9650, -74.7950], // Plaza de la Aduana
    [10.9550, -74.7700], // Carrera 50
    [10.9600, -74.7800], // Calle 37
    [10.9650, -74.7850], // Carrera 44
    [10.9600, -74.7900], // Calle 30
    [10.9700, -74.8000], // Carrera 39
    [10.9650, -74.7950], // Calle 28
    [10.9650, -74.7900], // Carrera 38
    [10.9600, -74.7800], // Calle 17
    [10.9800, -74.7600], // Calle 18
    [10.9850, -74.7500], // Carrera 19
    [10.9800, -74.7500], // Autopista aeropuerto
    [10.9700, -74.7600], // Carrera 17
